...
var (
	...
	dydxAssetData        = common.Hex2Bytes("")
)
...
func TestBatchOffchainValidateDyDxOrder(t *testing.T) {
	...
	ethRPCClient, err := ethrpcclient.New(rpcClient, defaultEthRPCTimeout, rateLimiter)
	require.NoError(t, err)
	// HACK(jalextowle) The DyDxBridge is not currently deployed to the ganache
	// snapshot so we add a fake address here that matches the bridge address in
	// the dydx asset data to verify that the validation works properly.
	dydxGanacheAddresses := ganacheAddresses
	dydxGanacheAddresses.DyDxBridge = common.HexToAddress("0x0000000000000000000000000000000000000011")
	orderValidator, err := New(ethRPCClient, constants.TestChainID, constants.TestMaxContentLength, dydxGanacheAddresses)
	require.NoError(t, err)
