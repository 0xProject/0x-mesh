...
type orderMessage struct {
	...
	Order       *zeroex.SignedOrderV3 `json:"order"`
	Topics      []string              `json:"topics"`
}

// OrderToRawMessage encodes an order into an order message to be sent over the wire
func OrderToRawMessage(topic string, order *zeroex.SignedOrderV3) ([]byte, error) {
...
func RawMessageToOrder(data []byte) (*zeroex.SignedOrderV3, error) {
