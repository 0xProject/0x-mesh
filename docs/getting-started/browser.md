...
[The examples/browser directory](https://github.com/0xProject/0x-mesh/tree/a428703d64b084f41ff11d678b47a1d01135c6f1/examples/browser/README.md) includes a bare-bones example of how to use the `@0x/mesh-browser` and bundle everything together with Webpack.
