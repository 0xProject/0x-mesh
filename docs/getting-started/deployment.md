...
There is one additional environment variable in the [main entrypoint for the Mesh executable](https://github.com/0xProject/0x-mesh/tree/9e86d4d3bf18fb19c9bbf04dcd3321490c819ba4/cmd/mesh/main.go):
