...
type FixtureTimestep struct {
	...
	BlockEvents      []*BlockEvent                   `json:"blockEvents" gencodec:"required"`
...
func (fc *FakeBlockClient) HeaderByNumber(ctx context.Context, number *big.Int) (*MiniBlockHeader, error) {
...
func (fc *FakeBlockClient) HeaderByHash(ctx context.Context, hash common.Hash) (*MiniBlockHeader, error) {
	timestep := fc.fixtureData[fc.currentTimestep]
...
func (fc *FakeBlockClient) ExpectedRetainedBlocks() []*MiniBlockHeader {
...
func (fc *FakeBlockClient) GetBlockEvents() []*BlockEvent {
