...
func (_DevUtils *DevUtilsCaller) DecodeERC20BridgeAssetData(opts *bind.CallOpts, assetData []byte) (struct {
	...
	outstruct.AssetProxyId = *abi.ConvertType(out[0], new([4]byte)).(*[4]byte)
	outstruct.TokenAddress = *abi.ConvertType(out[1], new(common.Address)).(*common.Address)
	outstruct.BridgeAddress = *abi.ConvertType(out[2], new(common.Address)).(*common.Address)
	outstruct.BridgeData = *abi.ConvertType(out[3], new([]byte)).(*[]byte)
...
func (_DevUtils *DevUtilsCaller) DecodeMultiAssetData(opts *bind.CallOpts, assetData []byte) (struct {
	...
	outstruct.NestedAssetData = *abi.ConvertType(out[2], new([][]byte)).(*[][]byte)
...
func (_DevUtils *DevUtilsCaller) DecodeStaticCallAssetData(opts *bind.CallOpts, assetData []byte) (struct {
	...
	outstruct.AssetProxyId = *abi.ConvertType(out[0], new([4]byte)).(*[4]byte)
	outstruct.StaticCallTargetAddress = *abi.ConvertType(out[1], new(common.Address)).(*common.Address)
	outstruct.StaticCallData = *abi.ConvertType(out[2], new([]byte)).(*[]byte)
	outstruct.ExpectedReturnDataHash = *abi.ConvertType(out[3], new([32]byte)).(*[32]byte)
...
func (_DevUtils *DevUtilsCaller) DecodeZeroExTransactionData(opts *bind.CallOpts, transactionData []byte) (struct {
	...
	outstruct.FunctionName = *abi.ConvertType(out[0], new(string)).(*string)
	outstruct.Orders = *abi.ConvertType(out[1], new([]LibOrderOrder)).(*[]LibOrderOrder)
	outstruct.TakerAssetFillAmounts = *abi.ConvertType(out[2], new([]*big.Int)).(*[]*big.Int)
...
func (_DevUtils *DevUtilsTransactor) GetOrderRelevantState(opts *bind.TransactOpts, order LibOrderOrder, signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function getOrderRelevantState((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes) order, bytes signature) returns((uint8,bytes32,uint256) orderInfo, uint256 fillableTakerAssetAmount, bool isValidSignature)
func (_DevUtils *DevUtilsSession) GetOrderRelevantState(order LibOrderOrder, signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function getOrderRelevantState((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes) order, bytes signature) returns((uint8,bytes32,uint256) orderInfo, uint256 fillableTakerAssetAmount, bool isValidSignature)
func (_DevUtils *DevUtilsTransactorSession) GetOrderRelevantState(order LibOrderOrder, signature []byte) (*types.Transaction, error) {
	return _DevUtils.Contract.GetOrderRelevantState(&_DevUtils.TransactOpts, order, signature)
}
...
func (_DevUtils *DevUtilsTransactor) GetOrderRelevantStates(opts *bind.TransactOpts, orders []LibOrderOrder, signatures [][]byte) (*types.Transaction, error) {
	return _DevUtils.contract.Transact(opts, "getOrderRelevantStates", orders, signatures)
}
...
//
// Solidity: function getOrderRelevantStates((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)[] orders, bytes[] signatures) returns((uint8,bytes32,uint256)[] ordersInfo, uint256[] fillableTakerAssetAmounts, bool[] isValidSignature)
func (_DevUtils *DevUtilsTransactorSession) GetOrderRelevantStates(orders []LibOrderOrder, signatures [][]byte) (*types.Transaction, error) {
	return _DevUtils.Contract.GetOrderRelevantStates(&_DevUtils.TransactOpts, orders, signatures)
}
