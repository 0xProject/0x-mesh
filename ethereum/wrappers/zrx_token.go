...
// ZRXTokenMetaData contains all meta data concerning the ZRXToken contract.
var ZRXTokenMetaData = &bind.MetaData{
...
// Deprecated: Use ZRXTokenMetaData.ABI instead.
var ZRXTokenABI = ZRXTokenMetaData.ABI
