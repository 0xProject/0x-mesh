...
func (cw *MeshWrapper) AddOrders(rawOrders js.Value, rawOptions js.Value) (js.Value, error) {
	var rawMessages []*json.RawMessage
	if err := jsutil.InefficientlyConvertFromJS(rawOrders, &rawMessages); err != nil {
		return js.Undefined(), err
	}
	var options *types.AddOrdersOpts
	if err := jsutil.InefficientlyConvertFromJS(rawOptions, &options); err != nil {
		return js.Undefined(), err
	}

	results, err := cw.app.AddOrdersRaw(cw.ctx, rawMessages, options)
	if err != nil {
		return js.Undefined(), err
	}
...
func (cw *MeshWrapper) GQLAddOrders(rawOrders js.Value, rawOptions js.Value) (js.Value, error) {
