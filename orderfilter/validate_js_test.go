...
var (
	testFilterValidateOrderExpectedErrors = [][]string{
		{},
		{
			`{"keyword":"enum","dataPath":".exchangeAddress","schemaPath":"/exchangeAddress/enum","params":{"allowedValues":["0x48BaCB9266a570d521063EF5dD96e61686DbE788","0x48bacb9266a570d521063ef5dd96e61686dbe788"]},"message":"should be equal to one of the allowed values"}`,
		},
		{
