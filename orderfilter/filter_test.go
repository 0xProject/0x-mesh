...
func TestFilterValidateOrder(t *testing.T) {
	...
	require.Equal(t, len(testCases), len(testFilterValidateOrderExpectedErrors))
	for i := 0; i < len(testCases); i++ {
		testCases[i].expectedErrors = testFilterValidateOrderExpectedErrors[i]
	}
...
func TestFilterValidateOrderJSON(t *testing.T) {
	...
	require.Equal(t, len(testCases), len(testFilterValidateOrderJSONExpectedErrors))
	for i := 0; i < len(testCases); i++ {
		testCases[i].expectedErrors = testFilterValidateOrderJSONExpectedErrors[i]
	}
